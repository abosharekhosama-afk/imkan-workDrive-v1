        ...
        <tbody>
          {sortedFolders.map((folder) => (
            <tr key={folder.id} className="imkan-table-row hover:bg-[color:var(--imkan-color-surface)] group">
              ...
              <td className="imkan-muted px-3 py-2 text-[length:var(--imkan-font-size-secondary)]">{folder.ownerName?? "—"}</td>
          ...
          {sortedFiles.map((file) => (
            <tr key={file.id} className="imkan-table-row hover:bg-[color:var(--imkan-color-surface)] group">
              ...
              <td className="imkan-muted px-3 py-2 text-[length:var(--imkan-font-size-secondary)]">{file.ownerName?? "—"}</td>
