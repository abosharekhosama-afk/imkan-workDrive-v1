...
export function FileBrowser({
  ...
  }, [filter, favoriteIds, files, folders, folderSizes, sortDir, sortField]);
    ...
    <section className="flex min-h-0 flex-1 flex-col w-full max-w-full overflow-x-hidden">
      ...
      {loading ? <SkeletonLoader columns={6} /> : viewMode === "grid" ? (
        ...
        <FileTable
          ...
          emptyAction={searchActive || (filteredContents.folders.length + filteredContents.files.length === 0 && filter !== "all") ? undefined : <FolderEmptyState />}
