      ...
      <div className="ms-auto flex items-center gap-1.5">
        ...
        <ZohoMenu open={openMenu === "new"} onClose={close} labelledBy="tb-new-btn" widthPx={405}
          onSelect={(k) => {
            ...
            else if (k === "templates") window.location.href = "/files/templates";
            else if (k === "externalApps") WorkdriveEvents.externalApps();
            else if (k === "record") window.dispatchEvent(new CustomEvent("workdrive:record", { detail: { kind: "video" } }));
            else openWip(label(k === "doc" ? "menu.newDoc" : k === "sheet" ? "menu.newSheet" : k === "slide" ? "menu.newSlide" : k === "code" ? "menu.codeSnippet" : "menu.link"));
          }}
          items={[
