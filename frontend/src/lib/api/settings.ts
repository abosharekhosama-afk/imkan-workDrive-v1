...
export type SessionRecord={id:string;createdAt:string;lastSeenAt:string;expiresAt:string;ipAddress?:string|null;userAgent?:string|null;deviceId?:string|null;isCurrent?:boolean};
...
export type SecurityEventRecord={id:string;severity:string;eventType:string;ipAddress?:string|null;metadata?:unknown;createdAt:string};
export const listSecurityEvents=()=>request<SecurityEventRecord[]>('/auth/security-events');
