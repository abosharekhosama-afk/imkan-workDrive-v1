...
export type AdminOverview={users:number;files:number;folders:number;shares:number;teamFolders:number}; export type AdminUser={id:string;name:string|null;email:string;role:string;createdAt:string};
