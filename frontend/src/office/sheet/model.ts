...
export type PivotTable = { id:string; name:string; sourceRange:string; destinationRange?:string; rowField?:string; columnField?:string; valueField?:string; filterField?:string; aggregation?:'sum'|'count'|'average'|'min'|'max' };
