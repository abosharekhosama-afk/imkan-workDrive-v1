...
export class EnterpriseService {
  ...
  async auditReport(user: AccessTokenPayload, input: any) {
    ...
    const ACTIONS: Record<string, string[]> = {
      FILES_FOLDERS: ['FILE_UPLOAD_COMPLETE','FILE_VERSION_UPLOADED','FILE_CREATED','FILE_CREATED_FROM_TEMPLATE','FILE_DOWNLOAD','FILE_DOWNLOADED','FILE_VERSION_DOWNLOAD','FILE_VIEWED','FILE_MODIFIED','FILE_RENAMED','FILE_TRASHED','FILE_PERMANENTLY_DELETED','FILE_RESTORED','RESTORE_VERSION','FILE_MOVED','FILE_COPIED','FOLDER_CREATED','FOLDER_RENAMED','FOLDER_TRASHED','FOLDER_DELETED','FOLDER_PERMANENTLY_DELETED','FOLDER_RESTORED','FOLDER_MOVED','FOLDER_COPIED','TRASH_EMPTIED','FILE_IMPORTED_FROM_CLOUD','FILE_VERSION_RESTORED'],
      'FILES_FOLDERS:UPLOAD': ['FILE_UPLOAD_COMPLETE','FILE_VERSION_UPLOADED'], 'FILES_FOLDERS:CREATE': ['FILE_CREATED','FILE_CREATED_FROM_TEMPLATE','FOLDER_CREATED'], 'FILES_FOLDERS:DOWNLOAD': ['FILE_DOWNLOAD','FILE_DOWNLOADED','FILE_VERSION_DOWNLOAD'], 'FILES_FOLDERS:VIEW': ['FILE_VIEWED'], 'FILES_FOLDERS:MODIFY': ['FILE_MODIFIED'], 'FILES_FOLDERS:RENAME': ['FILE_RENAMED','FOLDER_RENAMED'], 'FILES_FOLDERS:TRASH': ['FILE_TRASHED','FOLDER_TRASHED'], 'FILES_FOLDERS:DELETE': ['FILE_PERMANENTLY_DELETED','FOLDER_PERMANENTLY_DELETED','FOLDER_DELETED'], 'FILES_FOLDERS:PERMANENT_DELETE': ['FILE_PERMANENTLY_DELETED','FOLDER_PERMANENTLY_DELETED'], 'FILES_FOLDERS:RESTORE': ['FILE_RESTORED','FOLDER_RESTORED','FILE_VERSION_RESTORED','RESTORE_VERSION'], 'FILES_FOLDERS:MOVE': ['FILE_MOVED','FOLDER_MOVED'], 'FILES_FOLDERS:COPY': ['FILE_COPIED','FOLDER_COPIED'], 'FILES_FOLDERS:PURGED': ['TRASH_EMPTIED'], 'FILES_FOLDERS:TRANSFER_OWNERSHIP': ['ORG_OWNERSHIP_TRANSFERRED'],
      SHARING: ['SHARE','SHARE_CREATED','SHARE_ACCESS_REMOVED','SHARE_PERMISSION_CHANGED','SHARE_REVOKED','PUBLIC_SHARE_ACCESSED'], 'SHARING:SHARE': ['SHARE_CREATED'], 'SHARING:REMOVE_SHARE': ['SHARE_ACCESS_REMOVED','SHARE_REVOKED'], 'SHARING:MODIFY_SHARE': ['SHARE_PERMISSION_CHANGED'],
      ...
      TEAM_FOLDERS: ['TEAM_FOLDER_CREATED','TEAM_FOLDER_RENAMED','TEAM_FOLDER_DUPLICATED','TEAM_FOLDER_MEMBER_ADDED','TEAM_FOLDER_MEMBER_REMOVED','TEAM_FOLDER_MEMBER_ROLE_CHANGED','TEAM_FOLDER_MEMBER_UPDATED','TEAM_FOLDER_GROUP_ADDED','TEAM_FOLDER_GROUP_REMOVED','TEAM_FOLDER_GROUP_UPDATED','TEAM_FOLDER_SETTINGS_UPDATED','TEAM_FOLDER_DELETED','TEAM_FOLDER_RESTORED','TEAM_FOLDER_ARCHIVED','TEAM_FOLDER_UNARCHIVED'],
      'TEAM_FOLDERS:CREATE': ['TEAM_FOLDER_CREATED'], 'TEAM_FOLDERS:RENAME': ['TEAM_FOLDER_RENAMED'], 'TEAM_FOLDERS:DUPLICATE': ['TEAM_FOLDER_DUPLICATED'], 'TEAM_FOLDERS:ADD_MEMBERS': ['TEAM_FOLDER_MEMBER_ADDED','TEAM_FOLDER_GROUP_ADDED'], 'TEAM_FOLDERS:REMOVE_MEMBERS': ['TEAM_FOLDER_MEMBER_REMOVED','TEAM_FOLDER_GROUP_REMOVED'], 'TEAM_FOLDERS:UPDATE_MEMBER_ROLE': ['TEAM_FOLDER_MEMBER_ROLE_CHANGED','TEAM_FOLDER_MEMBER_UPDATED','TEAM_FOLDER_GROUP_UPDATED'], 'TEAM_FOLDERS:DELETE': ['TEAM_FOLDER_DELETED'], 'TEAM_FOLDERS:RESTORE': ['TEAM_FOLDER_RESTORED'], 'TEAM_FOLDERS:ARCHIVE': ['TEAM_FOLDER_ARCHIVED'], 'TEAM_FOLDERS:UNARCHIVE': ['TEAM_FOLDER_UNARCHIVED'],
      TEAM: ['ORG_INVITATION_CREATED','ORG_INVITATION_ACCEPTED','ORG_INVITATION_REVOKED','ORG_MEMBER_ACTIVATED','ORG_MEMBER_REMOVED','ORG_MEMBER_ROLE_CHANGED','ORG_MEMBER_SUSPENDED','ORG_OWNERSHIP_TRANSFERRED','OWNERSHIP_TRANSFERRED','USER_ACCOUNT_CREATED','USER_SUSPENDED','ADMIN_CONSOLE_SETTINGS_UPDATED','SECURITY_POLICY_CHANGED'],
      DATA_TEMPLATES: ['TEMPLATE_CREATED_FROM_FILE','TEMPLATE_CREATED','TEMPLATE_UPDATED','TEMPLATE_DELETED','TEMPLATE_DUPLICATED','TEMPLATE_VERSION_CREATED','TEMPLATE_VERSION_RESTORED','TEMPLATE_BUILDER_UPDATED','TEMPLATE_BUILDER_PUBLISHED','TEMPLATE_BUILDER_UNPUBLISHED','TEMPLATE_CERTIFIED','TEMPLATE_CONTENT_PUBLISHED','TEMPLATE_AUTOMATION_GENERATED','TEMPLATE_PERMANENTLY_DELETED','TEMPLATE_RESTORED'],
