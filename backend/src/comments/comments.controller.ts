...
export class CommentsController {
  ...
  @Get()
  list(@CurrentUser() u: AccessTokenPayload, @Param('fileId') id: string) {
    return this.s.list(u, id);
  }

  @Post()
  add(@CurrentUser() u: AccessTokenPayload, @Param('fileId') id: string, @Body() b: { body: string; parentId?: string }) {
