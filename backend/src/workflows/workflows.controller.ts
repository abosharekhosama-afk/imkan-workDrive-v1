...
export class WorkflowsController {
  ...
  @Post('/tasks/:id/complete') completeTask(@CurrentUser() user: AccessTokenPayload, @Param('id', new ParseUUIDPipe({ version: '4' })) id: string, @Body() body: { transitionId?: string; fieldValues?: Record<string, unknown> }) { return this.service.completeTask(user, id, String(body.transitionId ?? ''), body.fieldValues ?? {}); }
