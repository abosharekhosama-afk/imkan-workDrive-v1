CREATE TABLE `admin_console_settings` (
  `id` CHAR(36) NOT NULL,
  ...
  CONSTRAINT `admin_console_settings_org_id_fkey` FOREIGN KEY (`org_id`) REFERENCES `organizations`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
